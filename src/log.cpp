...
static const char *component_name(LogComponent c) {
  ...
  case LogComponent::Core:
    return "core";
  case LogComponent::Rpc:
    return "rpc";
  case LogComponent::EventSource:
    return "source";
  case LogComponent::Adapter:
    return "adapter";
  case LogComponent::Db:
    return "db";
  case LogComponent::Alert:
    return "alert";
  case LogComponent::Risk:
    return "risk";
  default:
    return "unknown";
  }
...
static std::array<std::shared_ptr<spdlog::logger>,
                  static_cast<size_t>(LogComponent::_Count)>
    g_loggers;
